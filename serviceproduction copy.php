...
<body style="background: #000;">
    ...
    <div class="page" style="background: #000;">
        ...
        <div class="site-main">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-7">
                            ...
                            <p id="nunn" style="margin-top: -10px;">Blue Bell Entertainment Production House in Mumbai is a team of young and experienced creative professionals from the entertainment industry.</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-7">
                            <div class="pt-40 res-991-pt-30">
                                ...
                                <p id="nun" style="line-height: 23px; font-size: 18px; color: #fff;">Let your product dominate the market</p>
                                <p id="nun" style="line-height: 23px; font-size: 14px; color: #fff;">The product videos we create for our clients turn out to be the best marketing tool. We work with professional filmmakers who produce high-definition product videos fit for digital broadcast. Our videos have a cinematic feel, featuring compelling storylines that engage viewers effectively.</p>
                            </div>
                        </div>
            ...
            <section class="ttm-row corporate-video-section" style="background: #111; margin-top: 20px;">
                <div class="container">
                    <div class="row">
                        <!-- Left Column -->
                        <div class="col-md-12 col-lg-7">
                            <div class="pt-40 res-991-pt-30">
                                <p id="nun" style="line-height: 23px; font-size: 18px; color: #fff;">Rise on the international horizon</p>
                                <p id="nun" style="line-height: 23px; font-size: 14px; color: #fff;">A corporate video is the most powerful communication tool for building your brand and promoting your business. Blue Bell, as a corporate video production company, understands the impact of a great video. We create unique videos with strong messages about your company’s products and services, all at competitive rates.</p>
                            </div>
                        </div>

                        <!-- Right Column -->
                        <div class="col-md-12 col-lg-5">
                            <img src="images/p.jpg" alt="Corporate Video Production" style="width: 100%; height: auto;">
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="ttm-row welcome-section clearfix "
                style="background-image: linear-gradient(rgb(0 0 0), #0000008a), url(images/scree.jpg);margin-top: -40px;margin-bottom: -35px;background-size: cover;background-attachment: fixed;">
                <div class="container">
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-12">
                                    <div class="ttm_single_image_wrapper mt_20 res-991-mt-0">
                                        ...
                                        <img id="sdf" src="images/p.jpg" style="border: 2px solid white;height: 315px;"
                                            alt="image" class="img-fluid">
                                        <p id="dfg" class="mach">Production House in Mumbai</p>
                                    </div>
                        ...
                        <div class="col-md-12 col-lg-6">
                            ...
                            <div class="ttm_single_image_wrapper mt_20 res-991-mt-0">
                                ...
                                <p class="mach">Entertainment production house in mumbai</p>
                            </div>
                        </div>
            ...
            <section class="ttm-row welcome-section clearfix " style="background:#000;">
                <div class="container" style="margin-top: -35px;">
                    <div class="row">
                        ...
                        <div id="notb" class="col-md-12 col-lg-12" style="margin-top: 85px;">
                            <div class="row">
                                <div class="col-md-12 col-lg-12">
                                    <div class="pt-40 res-991-pt-30">
                                        <div class="mt_19 mb-30 elementor-widget-container">
                                            <p id="nun"
                                                style="line-height: 20px;font-weight: 600;margin-top:-60px;font-size: 25px;color: #f8a519;">
                                                PRINT MEDIA
                                            </p>
                                        </div>
                                        <div class="mt_19 mb-30 elementor-widget-container">
                                            <p id="nun" style="line-height: 23px;font-size: 18px;color: #fff;">
                                                First impressiont
                                            </p>
                                        </div>
                                        <div class="mt_19 mb-30 elementor-widget-container">
                                            <p id="nun" style="line-height: 23px;font-size: 14px;color: #fff;">
                                                For Print Media we’ve got a great team of creative brains and we love
                                                what we do. We solve challenges by a creative strategy. We understand
                                                design and the Science behind Art. The purpose of design is to support
                                                the brand strategy, by being the
                                                face of it. The science behind our designs is to ensure that every
                                                single touch point that the brand uses to interact with its audiences is
                                                created to offer an integrated experience.
                                            </p>
                                        </div>
                                        ...
                                        <div class="mt_19 mb-30 elementor-widget-container">
                                            <p id="nunb" style="line-height: 23px;font-size: 14px;color: #fff;">
                                                We are creative & our creative, talented and experienced designers will
                                                prepare a creative which will be unique with a strong message related to
                                                your company’s products and services. Our talented and experienced
                                                Photographer understand The science behind our designs, creative, what
                                                your company is, what it does, how it communicates to potential
                                                customers and how you want them to perceive your company.At Blue Bell
                                                entertainment production house in Mumbai, Our Photographers
                                                understand all & shoot accordingly with product, models, props at
                                                different location with high definition camera’s & lights equipment’s
                                                that too at the most competitive rate.
                                            </p>
                                        </div>
